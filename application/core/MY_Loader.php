...
class MY_Loader extends CI_Loader {
	...
	function theme($template = '', $data = array(), $return = FALSE)
	{
		...
		$this->data = $this->_ci_prepare_view_vars($data);
		$this->return = $return;
	...
	function view($view, $vars = array(), $return = FALSE){		
		...
		// this part loads the template
			...
			$this->template_loaded = TRUE;
			$data = $this->_ci_prepare_view_vars($vars);
			...
			return $this->_ci_load(array(
				...
				'_ci_view' => '../../themes/'.$this->template.'/views/layouts/main.php',
				'_ci_vars' => $data, 
				'_ci_return' => $return)
			);
		}
