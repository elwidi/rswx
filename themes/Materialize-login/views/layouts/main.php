...
<head>
  ...
  <link href="<?php echo base_url();?>themes/Materialize/demo/css/layouts/page-center.css" type="text/css" rel="stylesheet" media="screen,projection">

  <!-- INCLUDED PLUGIN CSS ON THIS PAGE -->
  <link href="<?php echo base_url();?>themes/Materialize/demo/js/plugins/prism/prism.css" type="text/css" rel="stylesheet" media="screen,projection">
...
<body class="cyan">
  ...
  <!--prism-->
  <script type="text/javascript" src="<?php echo base_url();?>themes/Materialize/demo/js/plugins/prism/prism.js"></script>
  <!--scrollbar-->
